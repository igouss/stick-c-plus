#!/usr/bin/env bb
;; Generate platform-display/src/sprite/generated.rs from gen/frames.json.
;;
;;   just sprites          # regenerate + verify
;;   bb platform/platform-display/gen/generate.clj --check    # fail if the tree is stale
;;
...
(defn- emit [presets]
  (str "// @generated by platform-display/gen/generate.clj — DO NOT EDIT.\n"
       "//\n"
