...
//!
//! The plume streams its ~7500-point cloud through a [`FrondCompute`](art_display::FrondCompute)
...
fn main() {
    ...
    // streams its ~7500-point cloud through that port straight into the wire canvas — never buffered
